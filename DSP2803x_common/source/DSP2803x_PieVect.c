...
// Group 1 PIE Vectors
      ...
      rsvd_ISR,     // 1.2 ADC  // if this is rsvd_ISR, then INT10.2 should be defined as ADCINT2_ISR
      rsvd_ISR,        // 1.3
...
// Group 10 PIE Vectors
      ...
      ADCINT2_ISR,        // 10.2 If this is ADCINT2_ISR, then INT1.2 should be defined as rsvd_ISR
