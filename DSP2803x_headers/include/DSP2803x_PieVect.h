...
// Group 1 PIE Peripheral Vectors:
      PINT     rsvd1_1;   // ADC - if Group 10 ADCINT1 is enabled, this must be rsvd1_1
      PINT     rsvd1_2;   // ADC - if Group 10 ADCINT2 is enabled, this must be rsvd1_2
      PINT     rsvd1_3;
      PINT     XINT1;
      PINT     XINT2;
      PINT     ADCINT9;   // ADC
...
// Group 10 PIE Peripheral Vectors:
      PINT     ADCINT1; // Can be ADCINT1, but must make ADCINT1 in Group 1 space "reserved".
      PINT     ADCINT2; // Can be ADCINT2, but must make ADCINT2 in Group 1 space "reserved".
      PINT     ADCINT3;  // ADC
      PINT     ADCINT4;  // ADC
      PINT     ADCINT5;  // ADC
      PINT     ADCINT6;  // ADC
