...
volatile Uint16 Operational_State = 127;     //set to pre-op at start up by default --->requires NMT message to go to Op state
...
volatile Uint32 RxDataL = 0;
volatile Uint32 RxDataH = 0;
